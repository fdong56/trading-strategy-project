    ...
    <div className={className}>
      ...
      {trainPlotData ? (
        <div style={{ marginBottom: '20px' }}>
          <h4 style={{ marginBottom: '10px', color: '#374151' }}>Training Period Performance</h4>
        ...
        <div style={{ marginBottom: '20px' }}>
          <h4 style={{ marginBottom: '10px', color: '#374151' }}>Training Period Performance</h4>
          <span style={{ color: '#888' }}>No training result yet. Click "Train Model" to see results.</span>
        </div>
      )}
      ...
      {testPlotData ? (
        <div>
          <h4 style={{ marginBottom: '10px', color: '#374151' }}>Testing Period Performance</h4>
          <div style={{ background: 'white', padding: '20px', borderRadius: '8px' }}>
            <Line
              data={{
        ...
        <div>
          <h4 style={{ marginBottom: '10px', color: '#374151' }}>Testing Period Performance</h4>
          <span style={{ color: '#888' }}>No testing result yet. Click "Test Model" to see results.</span>
        </div>
      )}
    </div>
  );
